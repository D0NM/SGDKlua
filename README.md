...
PS To run Lua scripts right from VS Code I use Code Runner extension: [formulahendry.code-runner](https://marketplace.visualstudio.com/items?itemName=formulahendry.code-runner)
